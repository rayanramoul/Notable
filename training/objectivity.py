...
inputs = inputs.rename(index=str, columns={"NNPs": "NNP", "INs": "IN","TOs":"TO","JJS":"JJ","semicolon":";","commas":",","colon":":"})
kek = list(inputs)
...
modules = []
count=0
representation = [1000,1000,1000,1000,1000,1000,1000,1000,1000,1000,1000]
